...
Use the appropriate command according to guide:  [**01. Basic Command-Line Operations on HDFS**](https://github.com/nchalv/spark-workshop/blob/main/01.%20Basic%20HDFS%20operations.md) to copy the files in the `data/examples` directory to HDFS.
<details>
