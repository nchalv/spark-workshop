...
employees = sc.textFile("controller:54310/user/ubuntu/data/examples/employees.csv") \
...
employees_df = spark.read.csv("controller:54310/user/ubuntu/data/examples/employees.csv", header=False, schema=employees_schema)
...
employees = sc.textFile("controller:54310/user/ubuntu/data/examples/employees.csv") \
                .map(lambda x: (x.split(",")))
departments = sc.textFile("controller:54310/user/ubuntu/data/examples/departments.csv") \
                .map(lambda x: (x.split(",")))
...
employees_df = spark.read.format('csv') \
    .options(header='false') \
    .schema(employees_schema) \
    .load("controller:54310/user/ubuntu/data/examples/employees.csv")
...
departments_df = spark.read.format('csv') \
    ...
    .load("controller:54310/user/ubuntu/data/examples/departments.csv")
...
employees = sc.textFile("controller:54310/user/ubuntu/data/examples/employees2.csv") \
                .map(lambda x: (x.split(",")))
...
employees_df = spark.read.csv("controller:54310/user/ubuntu/data/examples/employees2.csv", header=False, schema=employees2_schema)
